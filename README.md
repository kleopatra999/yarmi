...
4. Добавить поддержку С++03, Или, вовсе исключить поддержку С++11
5. Добавить поддердку UDP/UDT
6. Добавить поддердку SSL
