...
4. Custom memory allocation по умолчанию (done!)
5. Добавить возможность выбора протокола
6. Добавить возможность использовать Unix domain socket
7. Не генерировать 'switch()' если всегод одна версия процедуры
